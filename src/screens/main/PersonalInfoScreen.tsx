...
export const PersonalInfoScreen: React.FC = () => {
  ...
  const financialItems = [
    ...
    },
    {
      icon: '🏦',
      label: 'Monthly EMI',
      value: financialData.monthlyEmi
        ? formatCurrency(financialData.monthlyEmi)
        : '—',
    },
    {
      icon: '📋',
      label: 'EMI Outstanding',
      value: financialData.emiOutstanding
        ? formatCurrency(financialData.emiOutstanding)
        : '—',
    },
    {
      icon: '📈',
      label: 'Monthly Investment',
      value: financialData.monthlyInvestment
        ? formatCurrency(financialData.monthlyInvestment)
        : '—',
    },
  ];
