...
import { colors, typography, spacing, radii, borderWidths } from '../constants';
...
function getTypeConfig(
    ...
    const base = (() => {
        switch (type) {
            case 'success':
                return { icon: '✅', iconBg: colors.successSubtle, confirmBg: colors.success };
            case 'error':
                return { icon: '❌', iconBg: colors.dangerSubtle, confirmBg: colors.danger };
            case 'warning':
                return { icon: '⚠️', iconBg: colors.warningSubtle, confirmBg: colors.warning };
            case 'danger':
                return { icon: '🗑️', iconBg: colors.dangerSubtle, confirmBg: colors.danger };
            default: // 'info'
    ...
    if (confirmVariant === 'danger') base.confirmBg = colors.danger;
    if (confirmVariant === 'primary') base.confirmBg = colors.primary;
                ...
                <View style={styles.overlay}>
                    <TouchableWithoutFeedback>
                        <View style={styles.card}>
                            ...
                            {/* Title */}
                            <Text style={[styles.title, children ? styles.titleForm : undefined]}>{title}</Text>
